/* Nigel - 30/8/2000
 *
 * This file was stolen from CodeWarrior 11. To get it to compile under Think C (v7),
 * I had to remove a duplicate 'typedef struct ataPBHeader ataPBHeader;', and add some defines
 */
