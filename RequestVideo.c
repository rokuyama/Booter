...
#	5th May 98	Nigel	Added junk for compiling under Symantec Think C v7
#
...
pascal void ModeListIterator(void *userData, DMListIndexType indexItem, DMDisplayModeListEntryPtr displaymodeInfo)
{
#if defined ( __SC__ )
#pragma unused indexItem
#endif
...
Boolean FindBestMatch (VideoRequestRecPtr requestRecPtr, short bitDepth, unsigned long horizontal, unsigned long vertical)
{
	...
	if	( requestRecPtr->displayMode == 0L
			&&
